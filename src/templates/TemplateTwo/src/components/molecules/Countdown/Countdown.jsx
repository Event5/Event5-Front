...
export function Countdown({ eventDate }) {
  ...
  return (
    <div className="Countdown">
      <h1 className="Template__H1">{timerDays}</h1>
      <h4 className="Template__H4">:</h4>
      <h1 className="Template__H1">{timerHours}</h1>
      <h4 className="Template__H4">:</h4>
      <h1 className="Template__H1">{timerMinutes}</h1>
      <h4 className="Template__H4">:</h4>
      <h1 className="Template__H1">{timerSeconds}</h1>
    </div>
  );
}
